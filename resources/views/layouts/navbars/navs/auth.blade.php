                    ...
                    <ul class="dropdown-menu dropdown-navbar">
                        ...
                        <li class="nav-link">
                            <form action="{{ url('out') }}" method="post">
                                @csrf
                                <button type="submit" href="{{ url('out') }}" class="nav-item dropdown-item">{{ __('Log out') }}</a>
                            </form>

                            <!-- <a href="{{ url('out') }}" class="nav-item dropdown-item" onclick="event.preventDefault();  document.getElementById('logout-form').submit();">{{ __('Log out') }}</a> -->
                        </li>
                    </ul>
                </li>
